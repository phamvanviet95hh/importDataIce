...
public class FacilityDischargeTypeCode {
    public static void main(String[] args) throws Exception {

        String tableName = "facility_discharge_type_code";
        String tableNameOld = "facility_discharge_type_code_old";
        ...
        File xmlFile = new File("C:\\Users\\phamv\\Desktop\\Gtel\\data\\facility_discharge_type_code_202507302314.xml");
        if (!xmlFile.exists()) {
